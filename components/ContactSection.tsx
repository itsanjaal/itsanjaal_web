  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at top right, #b91c1c, transparent 70%)",
        }}
      />
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="mb-14">
          ...
          <h2
            className="font-normal leading-none mb-3 text-gray-900"
            style={{
                ...
                {[
                  ...
                  return (
                    <a
                      ...
                      style={{
                        border: `1.5px solid ${sh ? "#b91c1c" : "#e5e7eb"}`,
                        background: sh ? "#b91c1c" : "#fff",
                        color: sh ? "#fff" : "#9ca3af",
                      }}
                    >
                      <svg
