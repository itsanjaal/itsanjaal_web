...
import ITCourseIcon from "./ITCourseIcon";
import UIUXIcon from "./UIUXIcon";
import DevOpsIcon from "./DevOpsIcon";
import ContentWritingIcon from "./ContentWritingIcon";
import AIStrategyIcon from "./AIStrategyIcon";
import { services } from "@/lib/services-data";

const iconMap: Record<string, React.ReactNode> = {
  "web-development": <WebDevIcon size={100} />,
  "mobile-app-development": <MobileAppIcon size={100} />,
  "it-course": <ITCourseIcon size={100} />,
  "ui-ux-design": <UIUXIcon size={100} />,
  devops: <DevOpsIcon size={100} />,
  "content-writing": <ContentWritingIcon size={100} />,
  "ai-strategy-prompt-engineering": <AIStrategyIcon size={100} />,
};
  ...
  return (
    <section id="services" className="relative py-28 bg-white overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(rgba(229,26,26,0.04) 1px, transparent 1px), linear-gradient(90deg, rgba(229,26,26,0.04) 1px, transparent 1px)",
      ...
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        <div className="mb-20">
          ...
          <p className="mt-4 text-lg text-gray-500 max-w-xl">
            End-to-end digital craftsmanship — from concept to launch and
            beyond.
          </p>
        </div>
            ...
            >
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-[#e51a1a] font-medium text-sm mb-4">
                    {service.tagline}
                  </p>
        ...
        <div className="mt-16 rounded-3xl bg-[#e51a1a] p-10 md:p-14 flex flex-col md:flex-row items-center justify-between gap-6 overflow-hidden relative">
          ...
          <div className="pt-1 flex justify-center">
            <button className="group flex items-center gap-3 p-4 text-[11px] lg:text-[14px] tracking-[0.25em] uppercase border-0 bg-white cursor-pointer text-destructive dark:text-gray-100 dark:hover:text-red-500 transition-colors duration-300 disabled:opacity-40 disabled:cursor-not-allowed">
