  ...
  return (
    <section className="relative py-16 px-5 sm:px-10 lg:px-16 bg-[#E2ECF7] overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none opacity-20">
        ...
        <svg
          className="absolute -top-20 right-0 w-[400px] sm:w-[600px] opacity-30"
          viewBox="0 0 600 600"
        >
          <path
      ...
      <div className="relative z-10 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
        ...
        <div className="pt-16 sm:pt-24">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#0B2E59] leading-tight mb-4">
            {title}
          </h1>
          <p className="text-base sm:text-lg text-[#0B2E59]/80 leading-relaxed mb-6">
            {description}
          </p>
              ...
              {features.map((feature, index) => (
                <li key={index} className="mb-3">
                  <div className="flex items-center gap-2">
                    <h3 className="font-semibold text-[#0B2E59] text-base sm:text-lg">
                      {feature.title}
                    </h3>
                    {index === 0 && (
                      <Star fill="#C4710D" stroke="0" className="w-4 h-4" />
                    )}
                  </div>
                </li>
              ))}
          ...
          <Button
            ...
            className="bg-red-600 text-white px-5 py-2 sm:px-6 sm:py-3 mb-4 hover:bg-white hover:text-red-600 hover:border-red-600 border-1 "
          >
            {enrollButtonText}
          </Button>
