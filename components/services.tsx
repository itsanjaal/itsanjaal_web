...
const services = [
  ...
  },
  {
    ...
    title: "UI/UX Design",
    description:
      "Beautiful, intuitive designs that enhance user engagement and drive conversions.",
  ...
  },
  {
    ...
    title: "Dev Ops",
    description:
      "Scalable and reliable infrastructure solutions to streamline your development and deployment processes.",
    features: [
      "Cloud Services",
      "CI/CD Pipelines",
      "Containerization",
  ...
  },
  {
    ...
    description:
      " Analyze and interpret biological data using Python programming and bioinformatics tools.",
    features: [
      "DNA Sequencing",
  ...
  },
  {
    ...
    description:
      "Professional content writing and academic assignments tailored to your needs.",
    features: [
      "SEO Writing",
      "Research Papers",
      "Blog Posts",
...
export default function Services() {
  ...
  return (
    <section
      id="services"
      ref={sectionRef}
      className="py-20 bg-amber-50 bg-white-50"
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 px-4 sm:px-0">
          {services.map((service, index) => {
            ...
            const colorClass =
              service.color === "red" ? "bg-red-600" : "bg-red-600";
