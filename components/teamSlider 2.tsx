...
function TeamCard({ member }: { member: TeamMember }) {
  return (
    <div className="w-80 flex-shrink-0 bg-slate-50 p-10 rounded-[2.5rem] border border-slate-100 flex flex-col items-center text-center group hover:bg-white hover:border-red-100 transition-colors duration-300">
      {/* Avatar */}
      <div className="w-28 h-28 relative mb-6 flex-shrink-0">
        {/* Dashed ring — only colour transitions, no rotation (avoids repaint) */}
        <div
          className="absolute -inset-3 rounded-full border border-dashed border-slate-300 group-hover:border-[#FF3131]"
